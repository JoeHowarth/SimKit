...
// Serialize, Deserialize)] pub struct MyState(pub MyStateSubType);
// pod! will take a block of definnitions and add the derives to each type
// definnition inside it }
#[macro_export]
macro_rules! pod {
    ($($item:item)* ) => {
        $(
